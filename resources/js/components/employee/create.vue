...
<div>
    ...
    <div>
        <div class="row">
     <router-link class="btn btn-primary ml-3" style="height:35px; width:200px;" to="/employee">All Employee</router-link>
                  ...
                  <form class="user" @submit.prevent="employeeInsert" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                             ...
                             <div class="col-md-6">
                               ...
                               <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Enter email"
                                v-model="form.email">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                               ...
                               <input type="date" class="form-control" id="exampleInputFirstName" placeholder="select date" v-model="form.joining_date">
                                <small class="text-danger" v-if="errors.joining_date">{{ errors.joining_date[0]}}</small>
                            </div>

                             <div class="col-md-6">
                                 <label>Enter NID</label>
                               <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Enter NID number" v-model="form.nid">
                   ...
                   <div class="form-group">
                        ...
                        <label class="custom-file-label" for="customFile">Choose file</label>
                             ...
                             <div class="col-md-6">
                                 <img :src="form.photo" alt="photo" style="height: 60px; width: 60px;">
    ...
    let file = event.target.files[0];
     if (file.size > 1048770) {
      ...
      reader.readAsDataURL(file);
        ...
        //  let file=Evenet.target.files[0];
