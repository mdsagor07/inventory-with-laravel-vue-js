...
<div>
    ...
    <div>
        <div class="row">
     <router-link class="btn btn-primary ml-3" style="height:35px; width:200px;" to="/supplier">All Supplier</router-link>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                             ...
                             <div class="col-md-6">
                                 <label>Enter shope Name</label>
                               <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Enter shopname"
