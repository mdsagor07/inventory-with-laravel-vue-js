<template>
 ...
 <div class="row">
  <router-link to="/employee" class="btn btn-primary ml-3" style="height:35px; width:200px;">All Employee </router-link>
  ...
  <select class="form-control" id="exampleFormControlSelect1" v-model="form.salary_month">
   ...
   <small class="text-danger" v-if="errors.salary_month"> {{ errors.salary_month[0] }} </small>   
     ...
     <div class="col-md-6">
         ...
         <input readonly type="text" class="form-control" id="exampleInputFirstName" placeholder="Enter Your Sallery" v-model="form.salary">
